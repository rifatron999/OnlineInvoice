...
Route::get('/portal/user/dueInvoiceList','userController@dueInvoiceView')->name('dueInvoiceView.index');
Route::get('/portal/user/draftInvoiceList','userController@draftInvoiceView')->name('draftInvoiceView.index');
